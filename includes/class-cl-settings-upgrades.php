...
class CL_Settings_Upgrade {
	...
	*/
	...
	private function cl_v30_upgrades() {
		...
		/** Design */
		$design_settings['html_background_color'] = $old_settings['html_background_color'];
		$design_settings['html_background_color_checkbox'] = $old_settings['html_background_color_checkbox'];
		$design_settings['html_background_color_opacity'] = $old_settings['html_background_color_opacity'];
		$design_settings['html_background_url'] = $old_settings['html_background_url'];
		$design_settings['html_background_position'] = $old_settings['html_background_position'];
		$design_settings['html_background_repeat'] = $old_settings['html_background_repeat'];
		$design_settings['html_background_size'] = $old_settings['html_background_size'];
		
		$design_settings['logo_background_url'] = $old_settings['logo_background_url'];
		$design_settings['logo_background_size_width'] = ''; // New
		$design_settings['logo_background_size_height'] = ''; // New
		$design_settings['logo_background_position'] = $old_settings['logo_background_position'];
		$design_settings['logo_background_repeat'] = $old_settings['logo_background_repeat'];
		$design_settings['logo_background_size'] = $old_settings['logo_background_size'];
		
		$design_settings['login_form_width'] = ''; // New
		
		$design_settings['login_form_background_color'] = $old_settings['login_form_background_color'];
		$design_settings['login_form_background_color_checkbox'] = $old_settings['login_form_background_color_checkbox'];
		$design_settings['login_form_background_color_opacity'] = $old_settings['login_form_background_color_opacity'];
		$design_settings['login_form_background_url'] = $old_settings['login_form_background_url'];
		$design_settings['login_form_background_position'] = $old_settings['login_form_background_position'];
		$design_settings['login_form_background_repeat'] = $old_settings['login_form_background_repeat'];
		$design_settings['login_form_background_size'] = $old_settings['login_form_background_size'];
		
		$design_settings['login_form_border_radius'] = $old_settings['login_form_border_radius'];
		$design_settings['login_form_border_size'] = $old_settings['login_form_border_size'];
		$design_settings['login_form_border_color'] = $old_settings['login_form_border_color'];
		$design_settings['login_form_border_color_checkbox'] = $old_settings['login_form_border_color_checkbox'];
		$design_settings['login_form_border_color_opacity'] = $old_settings['login_form_border_color_opacity'];
		$design_settings['login_form_box_shadow'] = $old_settings['login_form_box_shadow'];
		$design_settings['login_form_box_shadow_color'] = $old_settings['login_form_box_shadow_color'];
		$design_settings['login_form_box_shadow_color_checkbox'] = $old_settings['login_form_box_shadow_color_checkbox'];
		$design_settings['login_form_box_shadow_color_opacity'] = $old_settings['login_form_box_shadow_color_opacity'];
		
		$design_settings['label_color'] = $old_settings['label_color'];
		$design_settings['label_color_checkbox'] = $old_settings['label_color_checkbox'];
		$design_settings['label_color_opacity'] = $old_settings['label_color_opacity'];
		
		$design_settings['nav_color'] = $old_settings['nav_color'];
		$design_settings['nav_color_checkbox'] = $old_settings['nav_color_checkbox'];
		$design_settings['nav_color_opacity'] = $old_settings['nav_color_opacity'];
		$design_settings['nav_text_shadow_color'] = $old_settings['nav_text_shadow_color'];
		$design_settings['nav_text_shadow_color_checkbox'] = $old_settings['nav_text_shadow_color_checkbox'];
		$design_settings['nav_text_shadow_color_opacity'] = $old_settings['nav_text_shadow_color_opacity'];
		$design_settings['nav_hover_color'] = $old_settings['nav_hover_color'];
		$design_settings['nav_hover_color_checkbox'] = $old_settings['nav_hover_color_checkbox'];
		$design_settings['nav_hover_color_opacity'] = $old_settings['nav_hover_color_opacity'];
		$design_settings['nav_text_shadow_hover_color'] = $old_settings['nav_text_shadow_hover_color'];
		$design_settings['nav_text_shadow_hover_color_checkbox'] = $old_settings['nav_text_shadow_hover_color_checkbox'];
		$design_settings['nav_text_shadow_hover_color_opacity'] = $old_settings['nav_text_shadow_hover_color_opacity'];
		
		$design_settings['custom_css'] = wp_filter_nohtml_kses( $old_settings['custom_css'] );
		$design_settings['custom_html'] = wp_kses_post( $old_settings['custom_html'] );
		$design_settings['custom_jquery'] = wp_specialchars_decode( stripslashes( $old_settings['custom_jquery'] ), 1, 0, 1 );
		
		/** General */
		$general_settings['active'] = $old_settings['active'];
