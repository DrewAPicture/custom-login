...
$sections	= array(
	...
	array(
		'id'		=> CUSTOM_LOGIN_OPTION . '_extensions',
		'title'		=> __( 'Addons', CUSTOM_LOGIN_DIRNAME ),
		'submit'	=> false,
	),
);
 ...
 *
 */
$fields	[CUSTOM_LOGIN_OPTION . '_extensions'] = array(
	
	/** BREAK **/
	array(
		'name' 		=> 'break_1',
		'label'		=> sprintf( '<h4>%s</h4>', __( 'Custom Login Extensions', CUSTOM_LOGIN_DIRNAME ) ),
		'desc' 		=> '',
		'type' 		=> 'html',
	),
	/** BREAK **/
	...
	array(
		'name' 		=> 'break_2',
		'label'		=> '',
		'desc' 		=> CUSTOMLOGIN()->load_extensions(),
		'type' 		=> 'raw',
	),
);