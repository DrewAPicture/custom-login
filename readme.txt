...
**Version 3.0** is now 140% faster in the admin and uses a lot less resources! Minimum WordPress version 3.9.
...
Custom Login 3.0 now has many extensions to make your login page better!
...
= 3.0.0 =
Complete rewrite of Custom Login, be sure to run the update script.